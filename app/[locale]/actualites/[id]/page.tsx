  ...
  return (
    <>
      ...
      <main style={{ paddingTop: "80px" }}>
        ...
        <section className="px-4 sm:px-6 lg:px-8 pt-14 pb-12" style={{ background: BANNER }}>
          <div className="max-w-7xl mx-auto">
            <Link
              ...
              className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/60 hover:text-white mb-6"
            >
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black uppercase leading-tight text-white max-w-5xl mb-5">
              {article.title}
            </h1>
        ...
        {/* ── Image de l'article + Articles similaires, côte à côte ── */}
        <section className="px-4 sm:px-6 lg:px-8 py-10 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
            {article.image ? (
              <div className="relative h-64 sm:h-96 overflow-hidden rounded-sm">
