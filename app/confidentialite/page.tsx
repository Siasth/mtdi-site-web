...
const sections = [
  {
    ...
    paragraphs: [
      "Le responsable des traitements de données réalisés via ce site est le Ministère de la Transformation Digitale et de l'Innovation.",
    ],
  },
  {
    number: "02",
    ...
    paragraphs: [
      "Les données collectées varient selon les fonctionnalités utilisées :",
    ],
    list: [
      ...
      "Abonnement à la newsletter : adresse courriel — pour l'envoi des actualités du Ministère",
    ...
    paragraphs_after: [
      "Le site ne collecte aucune donnée sensible (santé, opinions politiques, religieuses, etc.).",
    ],
  },
  {
    number: "03",
  ...
  },
  {
    ...
    title: "Sécurité",
    paragraphs: [
      "Le Ministère met en œuvre les mesures techniques et organisationnelles appropriées pour protéger vos données contre l'accès non autorisé, la perte ou l'altération, en lien avec l'Agence Nationale de Sécurité des Systèmes d'Information (ANSSI-Bénin).",
    ],
  },
  {
    number: "09",
    title: "Mineurs",
    paragraphs: [
      "Le site n'est pas destiné à collecter sciemment des données de mineurs sans le consentement d'un titulaire de l'autorité parentale.",
    ],
  },
  {
    number: "10",
    ...
    paragraphs: [
      "Cette politique peut être mise à jour pour refléter des évolutions légales ou fonctionnelles. La date de dernière mise à jour figure en haut de page.",
    ],
  },
];
          ...
          >
            <div className="max-w-4xl mx-auto">
              <div className="flex items-baseline gap-4 mb-6">
                <span className="text-2xl font-black" style={{ color: JAUNE }}>
                  {section.number}
                </span>
                <h2 className="text-xs font-black uppercase tracking-widest" style={{ color: VERT }}>
                  {section.title}
                </h2>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                {section.paragraphs_after?.map((p, j) => (
                  <p key={`after-${j}`} className="text-anthracite/70 text-sm font-medium leading-relaxed whitespace-pre-line">
                    {p}
                  </p>
                ))}
              </div>
