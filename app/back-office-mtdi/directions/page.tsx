  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
        ...
        {visibleItems.length === 0 && <p className="p-8 text-center text-gray-400">{showDeleted ? "Aucun élément supprimé." : "Aucune direction"}</p>}
      </div>
          ...
          <form onSubmit={handleSave} className="bg-white rounded-xl p-6 w-[90%] max-w-2xl shadow-2xl space-y-4 my-auto">
            ...
            {activeLang === "fr" ? (
              <>
                ...
                <div><label className="block text-xs font-semibold text-gray-500 uppercase mb-1" htmlFor="directeur-optionnel">Directeur (optionnel)</label><input id="directeur-optionnel" value={form.director} onChange={(e) => setForm({ ...form, director: e.target.value })} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm" /></div>
