...
export default function AdminMediaMentions() {
  ...
  function load() { setLoading(true); fetch("/api/admin/media-mentions").then((r) => r.json()).then((d) => { setItems(d); setLoading(false); }); }
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
        ...
        {items.length === 0 && <p className="p-8 text-center text-gray-400">Aucune mention</p>}
      </div>
