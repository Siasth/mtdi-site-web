...
export default function MarkdownEditor({
  ...
  placeholder?: string;
  rows?: number;
  // ANO-115 : permet d'associer un <label htmlFor={id}> à la zone
  // éditable réelle (un <div contentEditable>, pas un <input>), pour que le
  // clic sur le label et les technologies d'assistance ciblent la bonne zone.
  id?: string;
}) {
