      ...
      <section className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleSmtpSave} className="space-y-3">
          ...
          <div>
            ...
            <input required value={smtp.user} onChange={(e) => setSmtp({ ...smtp, user: e.target.value })} placeholder="contact@mtdi.gouv.bj" className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm" />
          </div>
          <div>
          ...
          <div>
            ...
            <input required value={smtp.from} onChange={(e) => setSmtp({ ...smtp, from: e.target.value })} placeholder="contact@mtdi.gouv.bj" className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm" />
          </div>
