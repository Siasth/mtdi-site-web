          ...
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl sm:text-5xl lg:text-7xl font-black uppercase leading-none tracking-tight text-white">
              ...
              {!titre && (
                <>
                  <br />
                  <span style={{ color: JAUNE }}>construction</span>
                </>
              )}
            </h1>
          </div>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 sm:py-32 bg-gris-perle">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-anthracite/75 text-base font-medium leading-relaxed mb-10">
              Nos équipes travaillent activement à la mise en ligne de ce contenu.
              Revenez bientôt ou retournez à l'accueil pour découvrir
              les dernières actualités du Ministère.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/contact"
                className="text-sm font-bold uppercase tracking-wider text-anthracite/40 hover:text-anthracite transition-colors"
              >
                Nous contacter
              </Link>
            </div>
