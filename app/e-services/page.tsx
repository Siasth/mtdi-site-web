...
const services = [
  {
    title: "État civil",
    description: "Demandez vos actes de naissance, de mariage et de deces en ligne. Retirez vos documents dans le centre d'état civil de votre choix.",
  ...
  {
    title: "Fiscalité",
    description: "Declarez et payez vos impots en ligne via la plateforme e-Impots. Accedez à votre espace contribuable et suivez vos obligations fiscales.",
  ...
  {
    title: "Identité",
    description: "Obtenez votre carte nationale d'identité biometrique ou votre passeport via MonIdentite.bj. Suivez l'avancement de votre demande en temps reel.",
  ...
  },
  {
    ...
    description: "Demandez vos permis de construire, licences commerciales et autorisations administratives. Toutes vos démarches regroupees en un seul portail.",
  ...
  {
    title: "Éducation",
    description: "Inscriptions scolaires et universitaires, demandes de bourses d'études, equivalences de diplomes et orientation professionnelle en ligne.",
  ...
  {
    title: "Santé",
    description: "Gerez votre assurance maladie universelle (ARCH), consultez votre carnet de vaccination numérique et accedez aux services de santé en ligne.",
  ...
  },
  {
    ...
    description: "Consultez le plan foncier rural, demandez vos titres de propriété et effectuez vos transactions foncieres en toute sécurité via le guichet unique.",
  ...
  },
  {
    ...
    description: "Casier judiciaire, certificat de nationalite, legalisation de documents et autres démarches juridiques et administratives courantes.",
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-4 text-white/60 text-sm font-semibold uppercase tracking-widest">
              Vos démarches en ligne &middot; 24/7
            </p>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 bg-white">
          <div className="max-w-4xl mx-auto">
            <p className="text-anthracite/60 text-sm font-medium leading-relaxed">
              Le Gouvernement du Bénin poursuit la dematerialisation des services publics pour
              rapprocher l'administration des citoyens. Retrouvez ci-dessous l'ensemble des
              e-services disponibles sur la plateforme nationale <strong className="text-anthracite">service-public.bj</strong>,
              accessible à tout moment depuis n'importe quel appareil connecte.
            </p>
          </div>
        </section>
              ...
              {services.map((service) => (
                ...
                >
                  <div
                    ...
                    style={{ background: `${VERT}0a` }}
                  >
                    {service.icon}
                  </div>

                  <div className="flex-1">
                    <h3 className="text-anthracite font-black text-sm uppercase mb-2">
                      {service.title}
                    </h3>
                  ...
                  <div
                    className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider transition-all group-hover:gap-4"
                    style={{ color: VERT }}
                  >
                    Acceder
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-anthracite font-black text-2xl sm:text-3xl uppercase leading-tight mb-4">
              Toutes vos démarches<br />sur une seule plateforme
            </p>
            <p className="text-anthracite/50 text-sm font-medium leading-relaxed max-w-xl mx-auto mb-10">
              Rendez-vous sur service-public.bj pour acceder à l'ensemble des services
              dematerialises du Gouvernement du Bénin. Creez votre compte citoyen et
              effectuez vos démarches administratives sans vous deplacer.
            </p>
            <a
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 bg-gris-perle" style={{ borderTop: "1px solid rgba(0,0,0,0.08)" }}>
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 p-8 bg-white" style={{ border: "1px solid rgba(0,0,0,0.08)" }}>
              <div>
                <h3 className="text-anthracite font-black text-sm uppercase mb-1">
                  Besoin d'aide ?
                </h3>
                <p className="text-anthracite/50 text-xs font-medium">
                  Notre équipe d'assistance est disponible pour vous accompagner dans vos démarches en ligne.
                </p>
              </div>
