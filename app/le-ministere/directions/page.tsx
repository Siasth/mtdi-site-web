...
const directionsData = [
  {
    ...
    description:
      "Assure la programmation, la gestion administrative et financière du ministère. Supervise le budget, les ressources humaines, les marchés publics et la logistique.",
    accent: VERT,
  },
  {
    type: "Direction centrale",
  ...
  },
  {
    ...
    description:
      "La Direction des Médias est chargée de la politique audiovisuelle et de la transition numérique des médias publics et privés.",
    accent: "#EB0000",
  },
];

export default function DirectionsCentralesPage() {
  return (
    <>
      <Navbar />
              ...
              {directionsData.map((dir, i) => (
                ...
                >
                  <div className="flex flex-wrap items-center gap-3 mb-3">
                    ...
                    <span className="text-xs font-medium text-anthracite/40">
                      {dir.type}
                    </span>
                  </div>
                  <h3 className="text-anthracite font-black text-lg uppercase leading-snug mb-2">
                    {dir.name}
                  </h3>
                  {dir.director && (
                    <p className="text-xs font-semibold text-anthracite/50 mb-4">
                      Directeur : {dir.director}
                    </p>
                  )}
                  <p className="text-anthracite/60 text-sm font-medium leading-relaxed max-w-3xl">
                    {dir.description}
                  </p>
                </div>
              ))}
