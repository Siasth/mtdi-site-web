...
// "actualites", "stats" et "hero" ont migré vers la base de données (tables
// dédiées), "ministre" et "site_general" vers la table settings.
const VALID = ["galerie", "chantiers", "direct"];
