...
export type MinistreBio = {
  ...
  bioContentFr: string; bioContentEn: string; // HTML riche continu
  wikipediaUrl: string;
...
export const MINISTRE_BIO_DEFAULTS: MinistreBio = {
  ...
  bioContentFr: "<p>Mahuna Akplogan compte parmi les figures de l'intelligence artificielle au Bénin. Ingénieur-docteur et entrepreneur, il appartient à cette catégorie de praticiens chez qui la rigueur scientifique, la réflexion stratégique et l'attention portée aux équipes procèdent d'une même exigence : comprendre pour mieux servir.</p><p>Nommé en mai 2026 Ministre de la Transformation digitale et de l'Innovation, en charge de la stratégie nationale de l'intelligence artificielle par le Président Romuald Wadagni, il a pour mission de conduire la feuille de route technologique au service des politiques publiques et privées, et de bâtir un écosystème d'innovation dynamique, inclusif et compétitif, un Bénin appelé à devenir exportateur de technologie. Derrière ces objectifs se tient une conviction simple : la technologie ne vaut que par ce qu'elle change concrètement dans la vie des hommes, et d'abord par sa contribution à l'éradication de l'extrême pauvreté.</p><p>Son parcours s'est construit à la croisée de la recherche et de l'action. Doublement diplômé, ingénieur et titulaire d'un master de l'Université de Technologie de Compiègne, il est docteur en intelligence artificielle de l'Université Toulouse III – Paul Sabatier (École Doctorale Mathématiques, Informatique et Télécommunications), et titulaire d'un mineur en philosophie des technologies cognitives, discipline qui l'a tôt amené à interroger le sens de ce qu'il construit. Son expertise couvre le management de l'innovation et de la recherche et développement, au service de la résolution de problématiques complexes à fort impact.</p><p>Fort de plus de quinze années d'expérience, il a dirigé des programmes d'innovation d'envergure dans des environnements exigeants, en conjuguant la vision stratégique et l'exécution opérationnelle de projets à grande échelle. De cette expérience, il a retenu une certitude mesurée : la recherche ne prend son sens qu'en redescendant vers le concret, là où se jouent la compétitivité des organisations et l'autonomie stratégique des nations.</p><p>Entrepreneur engagé, il est cofondateur de l'association iSheero, initiative panafricaine dédiée à la formation de compétences d'excellence en data science, data engineering et infrastructures cloud. Cet engagement procède d'une conviction plus personnelle : le souci de transmettre ce qu'il a mis des années à apprendre, et de contribuer à l'émergence d'une génération capable de répondre aux enjeux du continent.</p><p>Attaché au développement des talents, Mahuna Akplogan consacre son action à la transmission des savoirs et à l'édification d'écosystèmes durables, où se rejoignent l'excellence technologique, l'impact sociétal et la croissance des organisations. Au fond, ce qui guide sa démarche tient moins à l'ambition qu'à une forme de fidélité : au savoir, à ceux qui viennent, et à l'idée que la valeur d'une œuvre se mesure à l'empreinte qu'elle laisse.</p>",
  bioContentEn: "<p>Mahuna Akplogan is one of the leading figures in artificial intelligence in Benin. An engineer-researcher and entrepreneur, he belongs to that category of practitioners in whom scientific rigour, strategic thinking and care for teams stem from the same demand: to understand in order to better serve.</p><p>Appointed in May 2026 as Minister of Digital Transformation and Innovation, in charge of the national artificial intelligence strategy by President Romuald Wadagni, his mission is to lead the technological roadmap in service of public and private policies, and to build a dynamic, inclusive and competitive innovation ecosystem — a Benin poised to become a technology exporter. Behind these objectives lies a simple conviction: technology is only worth what it concretely changes in people's lives, and above all through its contribution to eradicating extreme poverty.</p><p>His career was built at the crossroads of research and action. Doubly qualified, an engineer and master's degree holder from the University of Technology of Compiègne, he holds a doctorate in artificial intelligence from the University of Toulouse III – Paul Sabatier (Doctoral School of Mathematics, Computer Science and Telecommunications), and a minor in the philosophy of cognitive technologies — a discipline that led him early on to question the meaning of what he builds. His expertise covers innovation management and research and development, in service of solving complex, high-impact problems.</p><p>With more than fifteen years of experience, he has led large-scale innovation programmes in demanding environments, combining strategic vision with the operational execution of major projects. From this experience, he has drawn a measured certainty: research only makes sense when it returns to the concrete, where the competitiveness of organisations and the strategic autonomy of nations are at stake.</p><p>As a committed entrepreneur, he is co-founder of the iSheero association, a pan-African initiative dedicated to developing excellence in data science, data engineering and cloud infrastructure. This commitment stems from a more personal conviction: the desire to pass on what he spent years learning, and to contribute to the emergence of a generation capable of meeting the continent's challenges.</p><p>Committed to developing talent, Mahuna Akplogan devotes his work to knowledge transfer and the building of sustainable ecosystems, where technological excellence, societal impact and organisational growth converge. Ultimately, what guides his approach is less ambition than a form of fidelity: to knowledge, to those who come after, and to the idea that the value of a work is measured by the mark it leaves.</p>",
  parcoursFr: [
...
export async function getMinistreBio(): Promise<MinistreBio> {
  ...
  const merged = { ...MINISTRE_BIO_DEFAULTS, ...stored } as MinistreBio & { bioParagraphsFr?: string[]; bioParagraphsEn?: string[] };

  // Rétrocompatibilité : d'anciennes données en tableau de paragraphes
  // (avant le passage à un éditeur continu unique) sont fusionnées
  // automatiquement en un seul bloc HTML.
  const bioContentFr = typeof merged.bioContentFr === "string"
    ? merged.bioContentFr
    : Array.isArray(merged.bioParagraphsFr) ? merged.bioParagraphsFr.join("") : MINISTRE_BIO_DEFAULTS.bioContentFr;
  const bioContentEn = typeof merged.bioContentEn === "string"
    ? merged.bioContentEn
    : Array.isArray(merged.bioParagraphsEn) ? merged.bioParagraphsEn.join("") : MINISTRE_BIO_DEFAULTS.bioContentEn;
